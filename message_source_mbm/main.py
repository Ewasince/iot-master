...
from message_source_mlm.audio import get_waw, AudioRecognizerMLM
from message_source_mlm._command_performer import CommandPerformerMLM
from message_source_mlm._commands import get_current_time, get_os_type
from message_source_mlm.config import config
from message_source_mlm.interfaces.i_command_performer_mlm import ICommandPerformerMLM
from message_source_mlm.interfaces.i_messages_recognizer_mlm import IMessagesRecognizerMLM
from message_source_mlm.utils import extract_text_after_command, normalize_text


class MessagesLocalMic(IMessagesSource):
    def __init__(self, recognizer: IMessagesRecognizerMLM, performer: ICommandPerformerMLM):
...
if __name__ == "__main__":
    try:
        messages_recognizer = AudioRecognizerMLM()
        command_performer = CommandPerformerMLM()
